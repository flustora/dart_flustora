...
import 'package:flustora/src/data/services/eth/eth_chain_id_impl.dart';
...
void main() {
  late EthChainIdImpl _ethChainIdImpl;
  setUp(() {
    _ethChainIdImpl = EthChainIdImpl();
  });

  group('EthChainIdImpl => ', () {
    // write tests

    test(
      'the getEthChainId function of EthChainIdImpl should return an Map<String, dynamic> response which be a ("message":"good response") or ("message":"error")',
      () async {
        ...
        final _verifyValue = await _ethChainIdImpl.getEthChainId();
