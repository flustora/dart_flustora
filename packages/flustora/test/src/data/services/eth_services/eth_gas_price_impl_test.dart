...
import 'package:flustora/src/data/services/eth/eth_gas_price_impl.dart';
...
void main() {
  late EthGasPriceImpl _ethGasPriceImpl;
  setUp(() {
    _ethGasPriceImpl = EthGasPriceImpl();
  });

  group('EthGasPriceImpl => ', () {
    // write tests

    test(
      'the getEthGasPrice function of EthGasPriceImpl should return an Map<String, dynamic> response which be a ("message":"good response") or ("message":"error")',
      () async {
        ...
        final _verifyValue = await _ethGasPriceImpl.getEthGasPrice();
