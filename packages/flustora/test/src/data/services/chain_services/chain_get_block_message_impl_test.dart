...
void main() {
  late ChainGetBlockMessageImpl _chainGetBlockMessageImpl;
  setUp(() {
    _chainGetBlockMessageImpl = ChainGetBlockMessageImpl();
  });

  group('ChainGetBlockMessageImpl => ', () {
    // write tests
    test(
      'the getChainGetBlockMessage function of ChainGetBlockMessageImpl should return an Map<String, dynamic> response which be a ("message":"good response")',
      () async {
        ...
        final _verifyValue = await _chainGetBlockMessageImpl
    ...
    test(
      'the getChainGetBlockMessage function of ChainGetBlockMessageImpl should return an Map<String, dynamic> response which be a ("message":"error")',
      () async {
        //Arrange - Setup facts, Put Expected outputs or Initilize
        late http.Response _response;
        late Map<String, dynamic> _testValue;
        ...
        //Act - Call the function that is to be tested
        final _verifyValue =
            await _chainGetBlockMessageImpl.getChainGetBlockMessage(cid: {});
