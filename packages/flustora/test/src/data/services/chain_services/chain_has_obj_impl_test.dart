...
void main() {
  late ChainHasObjImpl _chainHasObjImpl;
  setUp(() {
    _chainHasObjImpl = ChainHasObjImpl();
  });

  group('ChainHasObjImpl => ', () {
    // write tests
    test(
      'the getChainHasObj function of ChainHasObjImpl should return an Map<String, dynamic> response which be a ("message":"good response")',
      () async {
        ...
        final _verifyValue = await _chainHasObjImpl.getChainHasObj(cid: {
          "/": "bafy2bzaceahirpzohp3nj7kl6cpktigcncewjrrvbrzn5wadvxbk6bnzsvxqi"
        });
    ...
    test(
      'the getChainHasObj function of ChainHasObjImpl should return an Map<String, dynamic> response which be a ("message":"error")',
      () async {
        //Arrange - Setup facts, Put Expected outputs or Initilize
        late http.Response _response;
        late Map<String, dynamic> _testValue;
