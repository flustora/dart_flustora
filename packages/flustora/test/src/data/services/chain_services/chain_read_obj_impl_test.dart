...
void main() {
  late ChainReadObjImpl _chainReadObjImpl;
  setUp(() {
    _chainReadObjImpl = ChainReadObjImpl();
  });

  group('ChainReadObjImpl => ', () {
    // write tests
    test(
      'the getChainReadObj function of ChainReadObjImpl should return an Map<String, dynamic> response which be a ("message":"good response")',
      () async {
        ...
        final _verifyValue = await _chainReadObjImpl.getChainReadObj(
          cid: {
            "/":
                "bafy2bzaceahirpzohp3nj7kl6cpktigcncewjrrvbrzn5wadvxbk6bnzsvxqi"
          },
    ...
    test(
      'the getChainReadObj function of ChainReadObjImpl should return an Map<String, dynamic> response which be a ("message":"error")',
      () async {
        //Arrange - Setup facts, Put Expected outputs or Initilize
        late http.Response _response;
        late Map<String, dynamic> _testValue;
