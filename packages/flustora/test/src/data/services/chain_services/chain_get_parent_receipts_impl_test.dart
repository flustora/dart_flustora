...
void main() {
  late ChainGetParentReceiptsImpl _chainGetParentReceiptsImpl;
  setUp(() {
    _chainGetParentReceiptsImpl = ChainGetParentReceiptsImpl();
  });

  group('ChainGetParentReceiptsImpl => ', () {
    // write tests
    test(
      'the getChainGetParentReceipts function of ChainGetParentReceiptsImpl should return an Map<String, dynamic> response which be a ("message":"good response")',
      () async {
        ...
        final _verifyValue = await _chainGetParentReceiptsImpl
    ...
    test(
      'the getChainGetParentReceipts function of ChainGetParentReceiptsImpl should return an Map<String, dynamic> response which be a ("message":"error")',
      () async {
        //Arrange - Setup facts, Put Expected outputs or Initilize
        late http.Response _response;
        late Map<String, dynamic> _testValue;
