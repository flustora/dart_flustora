...
void main() {
  late ChainTipSetWeightImpl _chainTipSetWeightImpl;
  setUp(() {
    _chainTipSetWeightImpl = ChainTipSetWeightImpl();
  });

  group('ChainTipSetWeightImpl => ', () {
    // write tests
    test(
      'the getChainTipSetWeight function of ChainTipSetWeightImpl should return an Map<String, dynamic> response which be a ("message":"good response")',
      () async {
        ...
        final _verifyValue =
            await _chainTipSetWeightImpl.getChainTipSetWeight(tipSetKey: [
          {
            "/":
                "bafy2bzacech7iq67p3twanzjl5e2qvojzss4btigfkuzocwnqy5oyygifsy6e"
          }
    ...
    test(
      'the getChainTipSetWeight function of ChainTipSetWeightImpl should return an Map<String, dynamic> response which be a ("message":"error")',
      () async {
        //Arrange - Setup facts, Put Expected outputs or Initilize
        late http.Response _response;
        late Map<String, dynamic> _testValue;
