...
void main() {
  late ChainGetBlockImpl _chainGetBlockImpl;
  setUp(() {
    _chainGetBlockImpl = ChainGetBlockImpl();
  });

  group('ChainGetBlockImpl => ', () {
    // write tests
    test(
      'the getChainGetBlock function of ChainGetBlockImpl should return an Map<String, dynamic> response which be a ("message":"good response")',
      () async {
        ...
        final _verifyValue = await _chainGetBlockImpl.getChainGetBlock(cid: {
          "/": "bafy2bzaceahirpzohp3nj7kl6cpktigcncewjrrvbrzn5wadvxbk6bnzsvxqi"
        });
    ...
    test(
      'the getChainGetBlock function of ChainGetBlockImpl should return an Map<String, dynamic> response which be a ("message":"error")',
      () async {
        //Arrange - Setup facts, Put Expected outputs or Initilize
        late http.Response _response;
        late Map<String, dynamic> _testValue;
